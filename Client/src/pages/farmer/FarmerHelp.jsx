  ...
  return (
    <div className={`farmer-welcome farmer-welcome--${theme} farmer-help`} lang={language === "hi" ? "hi" : "en"}>
      ...
      <main className="farmer-shell farmer-help__main" id="farmer-help-main">
        <header className="farmer-help__heading"><div><p className="farmer-help__eyebrow"><CircleHelp size={15} /> KisanSetu</p><h1>{copy.title}</h1></div><span className="farmer-help__heading-icon"><CircleHelp size={23} /></span></header>
