  ...
  return (
    <div className={`farmer-welcome farmer-welcome--${theme} farmer-settings`} lang={language === "hi" ? "hi" : "en"}>
      ...
      <main className="farmer-shell farmer-settings__main" id="farmer-settings-main">
        <header className="farmer-settings__heading"><div><p className="farmer-settings__eyebrow"><ShieldCheck size={15} /> KisanSetu</p><h1>{copy.title}</h1><p>{copy.subtitle}</p></div><span className="farmer-settings__heading-icon"><ShieldCheck size={23} /></span></header>
